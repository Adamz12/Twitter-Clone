...
function CommentModal() {
  const isOpen = useSelector((state) => state.modals.commentModal);
  ...
  return (
    <>
      ...
      >
        <div className="w-full h-full relative rounded-lg focus:outline-none bg-black border border-gray-500 sm:w-[600px] sm:h-[386px] text-white sm:p-10 p-4">
