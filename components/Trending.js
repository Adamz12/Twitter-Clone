  ...
  return (
    <div className="hidden lg:flex flex-col ml-7 mt-4">
      ...
      <div className="w-[300px] h-[500px] bg-white bg-opacity-10 rounded-3xl mt-3">
        <h1 className="font-bold text-xl p-3">What's happeining</h1>
        ...
        <div className=" p-3 relative">
          ...
          <p className="text-xs text-gray-500">190k Tweets</p>
        </div>
        <div className=" p-3 relative">
          <DotsHorizontalIcon className="w-5 text-gray-600 absolute right-4" />
          <p className="text-xs text-gray-500">Trending in the US</p>
        ...
        <div className=" p-3 relative">
          <DotsHorizontalIcon className="w-5 text-gray-600 absolute right-4" />
          <p className="text-xs text-gray-500">Trending in the US</p>
          <h1 className="text-[15px] font-bold">Bill getes</h1>
      ...
      <div className="w-[300px] h-[300px] bg-white bg-opacity-10 rounded-3xl mt-3">
        ...
        <div className="flex justify-between p-3">
          <div className="flex space-x-3">
            <img
              className="w-11 h-11 object-cover rounded-full"
              src="/assets/Cristiano-Ronaldo.webp"
            />
            <div>
              <div className="flex space-x-1">
                <h1 className="font-bold">Ronaldo</h1>
                <BadgeCheckIcon className="w-[18px] text-blue-400" />
              </div>
              <h1 className="text-[12px] mt-1 text-gray-500">@cr7</h1>
            </div>
          </div>
